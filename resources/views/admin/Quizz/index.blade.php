...
<a class="btn btn-success btn-block mt-5 mb-5" href="{{route('admin.quizz.create')}}">Crear evaluacion</a>
    <div class="card-body">
                    ...
                    @foreach($quizzes as $quiz)
                        <tr data-entry-id="{{ $quiz->id }}">
                            ...
                            <td>
                                ...
                                @can('category_delete')
                                    <form action="{{ route('admin.categories.destroy', $quizz->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
